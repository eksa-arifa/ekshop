...
const harga = document.querySelector('.pay .harga');
...
function clickfungsi(pilihan){
  ...
  if (pilihan.textContent == hide.value) {
    ...
    if(hide.value == 12){
      harga.textContent = "Rp.3000";
    }else if(hide.value == 50){
      harga.textContent = "Rp.8000";
    }else if(hide.value == 70){
      harga.textContent = "Rp.10000";
    }else if(hide.value == 140){
      harga.textContent = "Rp.20000";
